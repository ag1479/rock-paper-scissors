...
function game(userChoice) {
    ...
    if (userChoice === computerChoice) {
        result_h3.innerHTML = userChoice.charAt(0).toUpperCase() +
            userChoice.slice(1) + " and " + computerChoice + " are both the same. It's a draw.";
    } else if (userChoice === "rock" && computerChoice === "scissors") {
        result_h3.innerHTML = userChoice.charAt(0).toUpperCase() +
            userChoice.slice(1) + " beats " + computerChoice + ". You win.";
        userWin(); //calling the win function
    } else if (userChoice === "rock" && computerChoice === "paper") {
        result_h3.innerHTML = computerChoice.charAt(0).toUpperCase() +
            computerChoice.slice(1) + " beats " + userChoice + ". You lose.";
